...
internal class CarcassRepositoryImpl(
	...
	override suspend fun addCarcass(
		name: String,
		startDate: Instant,
		location: LatLon,
	...
	override suspend fun deleteCarcass(carcassId: Long) {
		withContext(Dispatchers.IO) {
			carcassQueries.delete(carcass_id = carcassId)
		}
	}

	override suspend fun updateCarcass(carcass: Carcass) {
		withContext(Dispatchers.IO) {
