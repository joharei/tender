...
private val colorScheme
	...
	get() = ColorScheme(
		...
		primaryFixed = colorResource(MR.colors.primaryFixed),
		primaryFixedDim = colorResource(MR.colors.primaryFixedDim),
		onPrimaryFixed = colorResource(MR.colors.onPrimaryFixed),
		onPrimaryFixedVariant = colorResource(MR.colors.onPrimaryFixedVariant),
		secondaryFixed = colorResource(MR.colors.secondaryFixed),
		secondaryFixedDim = colorResource(MR.colors.secondaryFixedDim),
		onSecondaryFixed = colorResource(MR.colors.onSecondaryFixed),
		onSecondaryFixedVariant = colorResource(MR.colors.onSecondaryFixedVariant),
		tertiaryFixed = colorResource(MR.colors.tertiaryFixed),
		tertiaryFixedDim = colorResource(MR.colors.tertiaryFixedDim),
		onTertiaryFixed = colorResource(MR.colors.onTertiaryFixed),
		onTertiaryFixedVariant = colorResource(MR.colors.onTertiaryFixedVariant),
	)
